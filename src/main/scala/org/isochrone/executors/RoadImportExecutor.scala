...
trait RoadImportExecutor extends ActionExecutor {
    ...
    abstract override def actions = super.actions + ("roadimport" --> new ActionComponent with OptionsBase with FromOptionDatabaseComponent with RoadImporterComponent with OsmTableComponent with DefaultRoadNetTableComponent with DefaultCostAssignerComponent {
