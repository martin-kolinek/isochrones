...
trait RoadVisualizeExecutor extends ActionExecutor {
    ...
    abstract override def actions = super.actions + ("roadvisualize" -> new ActionComponent with OptionsBase with FromOptionDatabaseComponent with OnlyDatabaseParserComponent with RoadNetVisualizerComponent with DefaultRoadNetTableComponent with DefaultVisualizationTableComponent with OsmTableComponent {
