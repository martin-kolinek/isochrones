...
trait SchemaExecutor extends ActionExecutor {
    ...
    trait CompleteTableCreatorComponent extends ActionComponent with DatabaseOptionParsingComponent with FromOptionDatabaseComponent with TableCreatorComponent with DefaultRoadNetTableComponent with DefaultVisualizationTableComponent with OptionsBase {
    }
